...
const DropdownUser = ({ dataUser }) => {
    ...
    return (
        ...
        >
            ...
            {dropdownOpen && (
                <div
                    className={`absolute right-0 mt-5 pt-4 flex w-56 flex-col rounded-sm border border-stroke bg-white shadow-black shadow-sm dark:border-strokedark dark:bg-boxdark`}
                >
