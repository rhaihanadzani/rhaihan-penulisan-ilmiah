    ...
    return (
        ...
        >
            <li>
                ...
                {dropdownOpen && (
                    <div
                        className={`absolute -right-16 mt-2.5 flex h-96 px-5 w-72 flex-col rounded-sm border border-stroke bg-white shadow-md shadow-black dark:border-strokedark dark:bg-boxdark sm:right-0 sm:w-80`}
                    >
