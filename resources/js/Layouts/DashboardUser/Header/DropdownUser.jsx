...
const DropdownUser = ({ dataUser }) => {
    const [dropdownOpen, setDropdownOpen] = useState(false);
    const isImageUser = dataUser.profile.image !== null;
    return (
        <ClickOutside
        ...
        >
            ...
            >
                <span className="hidden text-right lg:block">
                    ...
                    <span className="block text-xs">{dataUser.type}</span>
                </span>
                ...
                <span className="h-12 w-12 rounded-full">
                    <img
                        ...
                        alt="User"
                        className="h-full w-full rounded-full object-cover object-center border border-boxdark-2 dark:border-bodydark"
                    />
                </span>
            ...
            {dropdownOpen && (
                <div
                    className={`absolute right-0 mt-5 pt-4 flex w-56 flex-col rounded-sm border border-stroke bg-white shadow-black shadow-sm dark:border-strokedark dark:bg-background`}
                >
